...
New difficulties appear from the most common treatment strategies. The main strategy being through targeted and high doses of antibiotics. The concern arises given the fluctuating nature of STI treatment and costs. As such, costs for treatments have seen a markable increase with some treatments costing {[}enter average amount{]}. An increasing number of antibiotic-resistant gonorrhea is occurring globally, with a recent discovery in Japan with a strain that is resistant to ceftriaxone, the most prescribed antibiotic {[}citations{]}. Two individuals in the United Kingdom recently {[}2019{]} separately tested positive with different strains resistant to not just ceftriaxone but also azithromycin {[}citations{]}. The confirmed cases may seem small however, 10\% of men and half of women do not show visible symptoms when infected with the bacteria. Medical treatment alone has not been the only strides made in STIs around the with strides in acceptances and less persecution for those that have HIV for example. However, while persecution and stereotyping has gone down in recent years, treatments and availability to those treatments have become increasingly more costly.\\
...
\hypertarget{intended-purpose}{%
\subsection{Intended purpose}\label{intended-purpose}}

There are multiple intended purposes for the current dissertation. They range from the necessary completion but also to better understand the human decision-making process. For example, given the great complexities for human decision-making every decision made could and are completely different. These differences then make it difficult to distinguish and further experiment and then explain human decisions. Sexual decision-making is extremely difficult to research let alone the moral judgment aspects of sexual decision-making. Even though there is difficulty is doing an experimental analysis of human decision-making, methods of researching decision-making is an ever expanding field ecnompassing multiple fields from economics, philosophy, neuroscience, art, computers, and so on.

\hypertarget{exploratory-experiment-1}{%
\subsection{Exploratory Experiment 1:}\label{exploratory-experiment-1}}

\hypertarget{dominance-prestige-and-leadership-orientation-and-spitefulness}{%
\subsection{Dominance, Prestige, and Leadership orientation and Spitefulness}\label{dominance-prestige-and-leadership-orientation-and-spitefulness}}
...
\hypertarget{chapter-2-domain-specific-risk-taking-and-decision-making}{%
\section{Chapter 2: Domain Specific Risk-taking and Decision-making}\label{chapter-2-domain-specific-risk-taking-and-decision-making}}
...
\paragraph{\texorpdfstring{\emph{Dominance}}{Dominance}}\label{dominance}}
...
\paragraph{\texorpdfstring{\emph{Prestige}}{Prestige}}\label{prestige}}
...
\paragraph{\texorpdfstring{\emph{Leadership}}{Leadership}}\label{leadership}}
...
\paragraph{\texorpdfstring{\emph{Demographic Questionnaire}}{Demographic Questionnaire}}\label{demographic-questionnaire-1}}
...
\paragraph{\texorpdfstring{\emph{Dominance, Prestige, and Leadership Orientation}}{Dominance, Prestige, and Leadership Orientation}}\label{dominance-prestige-and-leadership-orientation-2}}
...
\paragraph{\texorpdfstring{\emph{Domain Specific Risk-taking Scale}}{Domain Specific Risk-taking Scale}}\label{domain-specific-risk-taking-scale}}
...
\paragraph{Preregistered Analyses}\label{preregistered-analyses}}
...
\paragraph{\texorpdfstring{\emph{Brief-Pathological Narcissism Inventory}}{Brief-Pathological Narcissism Inventory}}\label{brief-pathological-narcissism-inventory}}
...
\subsubsection{Future Implications}\label{future-implications}}
...
\includegraphics{Dissertation_files/figure-latex/unnamed-chunk-11-1.pdf} \includegraphics{Dissertation_files/figure-latex/unnamed-chunk-11-2.pdf} \includegraphics{Dissertation_files/figure-latex/unnamed-chunk-11-3.pdf}
...
\hypertarget{chapter-3-narcissism-and-decision-making}{%
\section{Chapter 3: Narcissism and Decision-Making}\label{chapter-3-narcissism-and-decision-making}}
...
\paragraph{\texorpdfstring{\emph{Brief-Pathological Narcissism Inventory}}{Brief-Pathological Narcissism Inventory}}\label{brief-pathological-narcissism-inventory-1}}
...
\paragraph{\texorpdfstring{\emph{Demographic and DoPL}}{Demographic and DoPL}}\label{demographic-and-dopl-2}}
...
\subsubsection{Future Implications}\label{future-implications-1}}
