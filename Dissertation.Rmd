...
keywords          : ""
wordcount         :  !expr wordcountaddin::word_count("Dissertation.Rmd")
...
# Chapter 2: Domain Specific Risk-taking and Decision-making

```{r child = "Chapter2.Rmd"}
```

# Chapter 3: Narcissism and Decision-Making
