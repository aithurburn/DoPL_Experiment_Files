...
m_1.int <- brm(generalRisk ~ dominanceSum*Gender+ prestigeSum*Gender + leadershipSum*Gender + Age, data=experiment_dataset_analysis,
              prior=c(prior(normal(0,1), class="Intercept"),
                      prior(normal(3,1), class="b", coef="dominanceSum"),
                      prior(normal(0,1), class="b", coef="prestigeSum"),
                      prior(normal(-2,1), class="b", coef="leadershipSum"),
...
m_1.int.hdi <- hdi(m_1.int, effects = "fixed", component = "conditional", ci = .95)
m_1.int.hdi
...
# I wasn't sure if the family=student should be carried over from the correlation matrix, nu prior should be deleted.

m_2 <- brm(mvbind(ethicalPreference, financialPreference, socialPreference, healthAndSafetyPreference, recreationalPreference) ~ dominanceSum + prestigeSum + leadershipSum + Gender + Age, data = experiment_dataset_analysis, family = student, # do we need this?
