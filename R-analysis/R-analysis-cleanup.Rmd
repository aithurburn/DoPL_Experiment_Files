...
experiment_1_Dataset <- experiment_1_Dataset[,-c(locfunc(experiment_1_Dataset, "PROLIFIC_PID"), locfunc(experiment_1_Dataset, "Q76"), locfunc(experiment_1_Dataset, "Q75"))]
```
...
# UMS
UMSQuestions <- c('UMS_1', 'UMS_2', 'UMS_3', 'UMS_4','UMS_5','UMS_6','UMS_7','UMS_8','UMS_9','UMS_10','UMS_11', 'UMS_12', 'UMS_13')
UMSIntimacyQuestions <- c('UMS_11', 'UMS_12', 'UMS_13')
UMSAffiliationQuestions <- c('UMS_1', 'UMS_2', 'UMS_3', 'UMS_4','UMS_5','UMS_6','UMS_7','UMS_8','UMS_9','UMS_10' )
...
healthAndSafetyQuestionsRisk <- c("risk_4", "risk_8", "risk_27", "risk_29", "risk_32", "risk_36", "risk_39", "risk_40")
recreationalQuestionsRisk <- c("risk_2", "risk_6", "risk_15", "risk_17", "risk_21", "risk_31", "risk_37", "risk_38")
socialQuestionsRisk <- c("risk_1", "risk_10", "risk_16", "risk_19", "risk_23", "risk_26", "risk_34", "risk_35")
...
healthAndSafetyQuestionsPerception <- c("riskPerception_4", "riskPerception_8", "riskPerception_27", "riskPerception_29", "riskPerception_32", "riskPerception_36", "riskPerception_39", "riskPerception_40")
recreationalQuestionsPerception <- c("riskPerception_2", "riskPerception_6", "riskPerception_15", "riskPerception_17", "riskPerception_21", "riskPerception_31", "riskPerception_37", "riskPerception_38")
socialQuestionsPerception <- c("riskPerception_1", "riskPerception_10", "riskPerception_16", "riskPerception_19", "riskPerception_23", "riskPerception_26", "riskPerception_34", "riskPerception_35")
...
healthAndSafetyQuestionsBenefit <- c("riskBenefit_4", "riskBenefit_8", "riskBenefit_27", "riskBenefit_29", "riskBenefit_32", "riskBenefit_36", "riskBenefit_39", "riskBenefit_40")
recreationalQuestionsBenefit <- c("riskBenefit_2", "riskBenefit_6", "riskBenefit_15", "riskBenefit_17", "riskBenefit_21", "riskBenefit_31", "riskBenefit_37", "riskBenefit_38")
socialQuestionsBenefit <- c("riskBenefit_1", "riskBenefit_10", "riskBenefit_16", "riskBenefit_19", "riskBenefit_23", "riskBenefit_26", "riskBenefit_34", "riskBenefit_35")
...
experiment_1_Dataset$UMSSum  <- rowSums(experiment_1_Dataset[, UMSIntimacyQuestions])
experiment_1_Dataset$UMSSum  <- rowSums(experiment_1_Dataset[, UMSAffiliationQuestions])
