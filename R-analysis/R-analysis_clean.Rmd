...
kable(m1_hdi[sign(m1_hdi$CI_low) == sign(m1_hdi$CI_high),
            c('Parameter', 'CI','CI_low', 'CI_high')], format = "html", booktabs = T, escape = F, longtable = F) %>% kable_styling(full_width = T)
```
...
kable(loo_table, format = "html", booktabs = T, escape = F, longtable = F) %>%
  kable_styling(full_width = F)
...
kable(loo_table2, format = "html", booktabs = T, escape = F, longtable = F) %>%
  kable_styling(full_width = F)
