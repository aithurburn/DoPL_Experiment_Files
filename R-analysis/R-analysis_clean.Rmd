...
```{r bayesian correlation, eval = F, message=FALSE, warning=FALSE}
library(brms)
library(rstan)
...
```{r main analysis, eval = F, message=FALSE, warning=FALSE}
...
## DoPL and General Risk Preference HDI
...
## HDI interval for interaction between gender and the DoPL motives. 
...
### HDI interval for interaction for gender and dominance orientation
...
```{r, eval = F, echo = T, results = 'hide', message=FALSE, warning=FALSE, message=FALSE, warning=FALSE}
...
```{r m7_DoPL and DOSPERT, eval = F, message=FALSE, warning=FALSE}
...
```{r Perceived risk and age, eval = F, message=FALSE, warning=FALSE}
...
```{r Benefit risk and age, eval = F, message=FALSE, warning=FALSE}
...
```{r Benefit risk and Gender, eval = F, message=FALSE, warning=FALSE}
...
```{r explorary model, eval = F, message=FALSE, warning=FALSE}
