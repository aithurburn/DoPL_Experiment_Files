...
Research in power desire motives has focused on three sub-domains: dominance, leadership, and prestige (Suessenbach et al., 2019). Each of these three different power motives is explained as to different ways or methods that individuals in power sought power or were bestowed upon them. thi
...
All relevant analyses were conducted in a Bayesian framework using the brms package (Bürkner, 2018) along with the cmdstanr packages notes
\# Results
...
Bürkner, P.-C. (2017). Brms: An R package for bayesian multilevel models using stan. \emph{Journal of Statistical Software}, \emph{80}(1, 1), 1--28. \url{https://doi.org/10.18637/jss.v080.i01}
...
Stan Development Team. (2020). \emph{RStan: The R interface to stan} (Version 2.26.1) {[}Computer software{]}. \url{https://mc-stan.org/}
