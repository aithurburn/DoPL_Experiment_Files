...
apa_table(
 demo_table, caption = "Participant demographic information (Experiment 1)", stub_indents = list("Age" = c(1:2), "Gender" = c(3:5), "Education" = c(6:12), "Ethnicity" = c(13:19)), font_size = "small", col.names = c("Variables", " *n* = 111"))
...
All relevant analyses were conducted in a Bayesian framework using the brms package [@burkner2018] along with the cmdstanr packages notes [@gabry2021]. In addition to the aforementioned packages, we used bayestestR, rstan, and papaja for analysis along with creation of this manuscript [@makowski2019; @aust2020; @standevelopmentteam2020].
