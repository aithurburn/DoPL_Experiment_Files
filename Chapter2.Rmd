...
All relevant analyses were conducted in a Bayesian framework using the brms package [@burkner2018] along with the cmdstanr packages notes [@gabry2021]. In addition to the aforementioned packages, we used bayestestR, cmdstanr, and papaja [@makowski2019; @gabry2021; @aust2020]. 
