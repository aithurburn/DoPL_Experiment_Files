...
\title{Power motivations and risk sensitivity and tolerance. Testing purposes}
...
\includegraphics{DoPL-Experiment_files/figure-latex/unnamed-chunk-4-1.pdf}

\includegraphics{DoPL-Experiment_files/figure-latex/unnamed-chunk-5-1.pdf} \includegraphics{DoPL-Experiment_files/figure-latex/unnamed-chunk-5-2.pdf} \includegraphics{DoPL-Experiment_files/figure-latex/unnamed-chunk-5-3.pdf}
...
Parameter & \multicolumn{1}{c}{CI} & \multicolumn{1}{c}{CI\_low} & \multicolumn{1}{c}{CI\_high}\\
\midrule
b\_ethicalPreference\_Intercept & 0.95 & 0.94 & 4.33\\
b\_ethicalPreference\_dominanceSum & 0.95 & 0.56 & 1.56\\
b\_financialPreference\_Intercept & 0.95 & 6.05 & 10.85\\
b\_financialPreference\_dominanceSum & 0.95 & 0.20 & 1.59\\
b\_socialPreference\_Intercept & 0.95 & 5.45 & 13.59\\
b\_socialPreference\_dominanceSum & 0.95 & 0.31 & 2.49\\
b\_healthAndSafetyPreference\_Intercept & 0.95 & 2.50 & 6.77\\
b\_healthAndSafetyPreference\_dominanceSum & 0.95 & 0.63 & 1.85\\
b\_recreationalPreference\_dominanceSum & 0.95 & 0.82 & 1.82\\
b\_recreationalPreference\_Gender & 0.95 & 0.48 & 1.82\\
b\_recreationalPreference\_Age & 0.95 & 0.00 & 0.11\\
\bottomrule
\end{tabular}
...
```\{=latex child = ``m3.tex'', include = FALSE, eval = FALSE\}
...
recreationalPreference

socialPreference

healthAndSafetyPreference
